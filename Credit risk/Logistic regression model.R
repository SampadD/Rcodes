...
CrossTable(y = loan_data$loan_status,x = loan_data$grade,prop.r = TRUE, prop.c = FALSE, prop.t = FALSE, prop.chisq = FALSE)
...
#Keeping it as a separate bucket
...
#Spltting data int test and train
